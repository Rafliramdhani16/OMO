...
<body class="bg-gray-50" x-data="{
            ...
            <div class="flex items-center justify-between px-4 h-16 py-6">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('front.check_booking') }}"
                        ...
                        <span
                            class="absolute -top-1 -right-1 bg-red-500 text-white text-xs w-4 h-4 flex items-center justify-center rounded-full">0</span>
                    </a>
    ...
    <div x-show="searchOpen" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0"
        x-transition:enter-end="opacity-100" x-cloak @keydown.escape.window="searchOpen = false"
        ...
        <div class="container mx-auto px-4 pt-24">
            <div class="bg-white rounded-xl p-4 shadow-xl max-w-2xl mx-auto">
                <div class="flex items-center gap-3">
                    ...
                    <input type="text" class="w-full text-sm outline-none" placeholder="Cari produk..."
                        @keydown.escape="searchOpen = false" autofocus>
                    <button @click="searchOpen = false" class="p-2 hover:bg-gray-100 rounded-full transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                d="M6 18L18 6M6 6l12 12" />
                        </svg>
